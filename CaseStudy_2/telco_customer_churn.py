...
df = pd.read_csv('Github_Machine_Learning/datasets/Telco-Customer-Churn.csv')
...
# TotalCharges için tip dönüşümü yapalım
...
df["TotalCharges"].fillna(df["MonthlyCharges"].median(), inplace=True)
